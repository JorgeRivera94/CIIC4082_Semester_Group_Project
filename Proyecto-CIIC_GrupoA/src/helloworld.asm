...
player_jump: .res 1   ;a byte to count the height of the player on a jump (starts at 0 and if Jump is called, atarts incrementing until it reaches $41)
